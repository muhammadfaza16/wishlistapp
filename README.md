...
- **Track wishes** with name, price, image, and purchase link
- **Savings progress** per item with visual progress bars
- **Tags** to organize and filter (Tech, Fashion, Experience, etc.)
